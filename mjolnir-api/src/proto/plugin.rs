...
pub struct Discover {
    ...
    alerts: ::protobuf::RepeatedField<Alert>,
    webhook: ::std::option::Option<bool>,
...
impl Discover {
    ...
    pub fn clear_webhook(&mut self) {
        self.webhook = ::std::option::Option::None;
    }
    ...
    // Param is passed by value, moved
    pub fn set_webhook(&mut self, v: bool) {
        self.webhook = ::std::option::Option::Some(v);
    }

    pub fn get_webhook(&self) -> bool {
        self.webhook.unwrap_or(false)
    }

    fn get_webhook_for_reflect(&self) -> &::std::option::Option<bool> {
        &self.webhook
    }

    fn mut_webhook_for_reflect(&mut self) -> &mut ::std::option::Option<bool> {
        &mut self.webhook
    }

    // repeated .Mjolnir.RemediationRequest actions = 6;
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ...
                    self.webhook = ::std::option::Option::Some(tmp);
                },
                6 => {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                    "webhook",
                    Discover::get_webhook_for_reflect,
                    Discover::mut_webhook_for_reflect,
                ));
